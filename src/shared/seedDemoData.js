/**
 * Datos de demo compartidos: misma fuente que Electron (`main/seed.js`) y PWA (IndexedDB).
 */
...
/** Tuplas: codigo, nombre, descripcion, catIdx, provIdx, precio_compra, precio_venta, stock, stock_min, unidad */
export const PRODUCTOS = [
  ...
  ['PLI004', 'Ficus Benjamina 60cm',          'Árbol de interior elegante',                 0, 0, 1200,2200,  11, 3,  'unidad'],
  ['PLI005', 'Dracaena Marginata 40cm',       'Planta de interior moderna',                 0, 0,  900,1800,   9, 3,  'unidad'],
  ['PLI006', 'Cactus Variado 10cm',           'Mix de cactus en maceta pequeña',            0, 0,  180, 350,  48, 10, 'unidad'],
  ...
  ['PLE005', 'Bugambilia 25cm',               'Trepadora de flor fucsia intensa',            1, 0,  420, 820,  14, 3,  'unidad'],
  ...
  ['PLE008', 'Ciprés Italiano 80cm',          'Árbol perenne de forma columnar',            1, 0,  950,1800,   6, 2,  'unidad'],
  ...
  ['MAC003', 'Maceta Plástica 35cm',          'Maceta grande con plato',                    3, 1,  220, 420,  29, 6,  'unidad'],
  ['MAC004', 'Maceta Cerámica 15cm',          'Maceta de cerámica esmaltada',               3, 1,  350, 680,  24, 5,  'unidad'],
  ['MAC005', 'Maceta Cerámica 25cm',          'Maceta cerámica premium',                    3, 1,  580,1100,  14, 3,  'unidad'],
  ['MAC006', 'Macetón Terracota 40cm',        'Macetón clásico de terracota',               3, 1,  480, 920,  11, 3,  'unidad'],
  ['MAC007', 'Jardinera Rectangular 60cm',    'Jardinera para balcón o borde',              3, 1,  320, 620,  20, 4,  'unidad'],
  ['MAC008', 'Colgante Macramé',              'Soporte colgante artesanal para maceta',     3, 4,  280, 550,  15, 4,  'unidad'],
  ...
  ['RAM003', 'Girasoles x6',                  'Girasoles frescos de tallo largo',           4, 3,  500, 980,   9, 2,  'unidad'],
  ...
  ['TIE005', 'Mantillo 20L',                  'Abono orgánico enriquecido',                 5, 0,  420, 800,  18, 4,  'unidad'],

  ['PES001', 'Fertilizante Plantas Verdes 500ml','Fórmula alta en nitrógeno',              6, 2,  280, 540,  30, 6,  'unidad'],
  ['PES002', 'Fertilizante para Flores 500ml',   'Estimula la floración',                  6, 2,  290, 550,  27, 6,  'unidad'],
  ['PES003', 'Insecticida Sistémico 250ml',       'Controla pulgones y cochinillas',        6, 2,  350, 680,  20, 4,  'unidad'],
  ['PES004', 'Fungicida Preventivo 250ml',        'Previene hongos y mildiu',               6, 2,  320, 620,  17, 4,  'unidad'],
  ['PES005', 'Abono Orgánico 1kg',                'Abono de liberación lenta',              6, 2,  240, 460,  24, 5,  'unidad'],
  ...
  ['DEC004', 'Cáscara de Pino Decorativa 2L', 'Mulch decorativo natural',                   7, 4,  160, 300,  23, 5,  'unidad'],
  ['DEC005', 'Grava Volcánica 1kg',           'Piedra volcánica para drenaje y deco',       7, 4,  150, 280,  30, 6,  'kg']
]

export const DEMO_PRODUCT_CODES = PRODUCTOS.map((p) => p[0])
