...
import {
  ...
  BarcodeOutlined, ScanOutlined, KeyOutlined, PrinterOutlined,
  SearchOutlined, PlusOutlined, EditOutlined, DollarOutlined,
  QuestionCircleOutlined, CheckCircleOutlined, WarningOutlined
      ...
      <Section icon={<AppstoreOutlined />} title="Productos" color="#1677ff">
        <Collapse ghost defaultActiveKey={[]}>
          ...
          <Panel header={<Text strong>Editar un producto o sumar stock</Text>} key="prod-editar">
            ...
            <Paso numero={4} texto='Hacer clic en "Guardar".' />
      ...
      <Section icon={<ShoppingCartOutlined />} title="Ventas" color="#52c41a">
        <Collapse ghost>
          <Panel header={<Text strong>Realizar una venta</Text>} key="venta-nueva">
            ...
            <Paso numero={5} texto='Seleccionar el método de pago: efectivo, tarjeta, transferencia o cuenta corriente.' />
            <Paso numero={6} texto='Confirmar la venta. El sistema descuenta el stock automáticamente.' />
            <Tip>Al pagar en efectivo podés ingresar el monto recibido y el sistema calcula el vuelto automáticamente.</Tip>
          </Panel>
      ...
      <Section icon={<InboxOutlined />} title="Stock e inventario" color="#fa8c16">
        <Collapse ghost>
          ...
          <Panel header={<Text strong>Historial de movimientos</Text>} key="stock-historial">
            <Paragraph>
              Cada vez que se crea un producto con stock inicial, se realiza una venta, se suma stock al editar un producto
              o se hace un ajuste, queda un registro en el historial de movimientos con fecha, usuario y motivo.
            </Paragraph>
          </Panel>
          <Panel header={<Text strong>Alertas de stock bajo</Text>} key="stock-alertas">
            <Paragraph>
              En el <strong>Dashboard</strong> se muestra una sección de alertas con los productos que tienen stock
              actual igual o menor al stock mínimo configurado. Configurá el stock mínimo en cada producto
      ...
      <Section icon={<BarChartOutlined />} title="Reportes" color="#fa541c">
        <Collapse ghost>
          ...
          <Panel header={<Text strong>Dashboard de resumen diario</Text>} key="rep-dashboard">
            <Paragraph>
              El <strong>Dashboard</strong> (pantalla principal) muestra un resumen del día actual: ventas del día,
              dinero cobrado, productos activos, alertas de stock bajo y un gráfico de los últimos 7 días.
            </Paragraph>
          </Panel>
        </Collapse>
      </Section>
